...
public class SeparateChainingHashST<, Value>:
    ...
    private SequentialSearchST<, Value>[] st;  # array of linked-list symbol tables
    ...
    def delete( key):
        ...
        if M > INIT_CAPACITY and N <= 2*M) resize(M/2)
