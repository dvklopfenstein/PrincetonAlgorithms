...
public class Particle:
    ...
    private count;        # number of collisions so far
    ...
    #*
     ...
     # {@link bounceOffVerticalWall}, and {@link bounceOffHorizontallWall}.
     #
    ...
    def timeToHit(Particle that):
        ...
        # if (drdr < sigma*sigma) prt.write("overlapping particles")
    ...
    #*
     ...
     #/
    def timeToHitVerticalWall():
        if      vx > 0) return (1.0 - rx - radius) / vx
        elif (vx < 0) return (radius - rx) / vx
    ...
    #*
     ...
     #/
    def timeToHitHorizontalWall():
        if      vy > 0) return (1.0 - ry - radius) / vy
        elif (vy < 0) return (radius - ry) / vy
        else:             return INFINITY
